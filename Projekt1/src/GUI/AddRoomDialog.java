...
public class AddRoomDialog extends JDialog {
    ...
    public AddRoomDialog(JFrame parent) {
        ...
        setSize(850, 850); // Większy rozmiar dla dialogu dodawania pokoju
    ...
    // --- Metoda pomocnicza do tworzenia stylizowanych przycisków (przeniesiona z SmartHomeGUI/AddHouseDialog) ---
